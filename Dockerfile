...
RUN apk add --update --no-cache gcc build-base python3-dev py3-pip libffi-dev libressl-dev curl openssl openssl-dev \
  musl-dev rust cargo bash s6 su-exec xmlstarlet && \
